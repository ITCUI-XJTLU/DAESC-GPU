...
OUTPUT_DIR_BASE="/projects/gqilab/DAESC_GPU/data/Test_run_pool1/com_skip_682_683"
LOG_DIR="/projects/gqilab/DAESC_GPU/data/Test_run_pool1/Scripts"

BARCODE_DIR="/projects/gqilab/DAESC_GPU/data/cellbarcodes"
...
for SAMPLE_ID in "${SAMPLE_IDS[@]}"; do
    ...
    for CHR in "${CHROMOSOMES[@]}"; do
        ...
        --modality rna \
        --interval chr${CHR} \
        --barcodes ${BARCODE_DIR}/ind_${SAMPLE_ID}_cellbarcodes.csv \
