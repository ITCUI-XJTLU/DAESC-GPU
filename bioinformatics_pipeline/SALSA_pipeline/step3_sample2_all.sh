...
# 2024/9/26 我们改变策略，首先把sample2的所有individual 都跑完

# SAMPLE_IDS=("662_663" "663_664" "664_665" "695_696" "696_697" "697_698" "699_700" "700_701" "701_702" "702_703" "704_705") # "661_662" 已经处理好了
SAMPLE_IDS=("662_663")
...
OUTPUT_DIR_BASE="/projects/gqilab/DAESC_GPU/data/OneK1K_Alldata/Sample2"
LOG_DIR="/projects/gqilab/DAESC_GPU/data/OneK1K_Alldata/Sample2/step3_scripts"

BARCODE_DIR="/projects/gqilab/DAESC_GPU/data/OneK1K_Alldata/Sample2/Sample2_cellbarcode"
...
for SAMPLE_ID in "${SAMPLE_IDS[@]}"; do
    ...
    for CHR in "${CHROMOSOMES[@]}"; do
        ...
        # step3 phase vcf files
        #bash /projects/gqilab/DAESC_GPU/data/SALSA/step3_phase_vcf.sh \
        #--library_id pbmc_1k \
        #--inputvcf ${OUTPUT_DIR_BASE}/com_${SAMPLE_ID}/com_${SAMPLE_ID}_step1/filtered_com_${SAMPLE_ID}.rna.chr${CHR}.vcf.gz \
        #--outputdir ${OUTPUT_DIR_BASE}/com_${SAMPLE_ID}/com_${SAMPLE_ID}_step3 \
        #--outputvcf com_${SAMPLE_ID}.pass.rna.chr${CHR}hcphase.vcf.gz \
        #--phasingref ${PHASING_REF} \
        #--interval chr${CHR} \
        #--hcphase \
        #--snvonly \
        #--verbose \
        ...
        --library_id pbmc_1k \
        --inputvcf ${OUTPUT_DIR_BASE}/com_${SAMPLE_ID}/com_${SAMPLE_ID}_step3/com_${SAMPLE_ID}.pass.rna.chr${CHR}hcphase.vcf.gz \
