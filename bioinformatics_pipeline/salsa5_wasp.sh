...
Usage: step6_wasp.sh [-vbdogianlmpt]
  ...
  -c  | --chromInfo         STR   path/to/chromInfo
...
-o v:b:d:o:g:i:c:a:n:m:l:pt:h \
--long inputvcf:,inputbam:,outputdir:,outputbam:,genotype:,stargenome:,chromInfo:,atacref:,library_id:,modality:,interval:,isphased,threads:,help -- "$@")
...
do
  case "$1" in
    ...
    -c | --chromInfo)         chromInfo=$2     ; shift 2 ;;
